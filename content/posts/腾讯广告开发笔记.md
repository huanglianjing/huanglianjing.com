...
![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_app.png)
...
![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_wechat_pyq.png)

![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_wechat_gzh.png)

![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_wechat_xcx.png)

### 1.1.2 QQ

QQ上有手机QQ广告、QQ空间广告这两种形式。

![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_qq_mobile.png)

![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_qq_kongjian.png)

### 1.1.3 腾讯视频

腾讯视频有闪屏、前贴片、信息流大图等版位可供广告投放展示选择。

![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_video_shanping.png)

![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_video_qiantiepian.png)

![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_video_xinxiliu.png)
...
![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_steps.png)
...
![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_create_campaign_setting.png)

设置广告：渠道包，广告版位（朋友圈、公众号、QQ、腾讯新闻等），定向，排期与出价出价，名称。

![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_create_adgroup_setting_1.png)

![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_create_adgroup_setting_2.png)

![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_create_adgroup_setting_3.png)

设置创意：创意形式，素材，创意组件，跳转URL。

![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_create_creative_setting_1.png)

![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_create_creative_setting_2.png)
...
![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_data_report_seq.png)

数据中心通过组合各种维度的查询，通过趋势图、柱状图、饼图等多种图形化或报表形式，及时、直观地掌握投放效果情况。

![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_data_report.png)
...
![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_wordtable_1.png)

在资产授权页面，可以在账号间进行创意素材、人群包、落地页等的夸张户授权。

![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_wordtable_2.png)

点进其中一个账号的投放平台页面。

在推广页面可以看到账号下的推广计划、广告、广告创意、商品、关键词的配置和数据的报表。

![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_wordtable_3.png)

在报表页面可以看到各个维度下指定时间范围和口径的数据报表。

![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_wordtable_4.png)

在资产页面，可以查看账号拥有的图片视频素材、商品广告、门店管理等内容。

![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_wordtable_5.png)

在工具页面中，有转化归因、点击检测、创意中心、各种落地页等辅助平台和工具。

![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_wordtable_6.png)
...
![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_process.jpg)
...
目前 custom_audience_files/add 及 custom_tag_files/add 两个接口对每个应用程序都有调用天频次限制，每个应用程序调用每个接口都有分钟频次限制，不同应用登记的调用次数不同。达到限制后需要暂停调用，5分钟后自动恢复正常。
...
![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_response.jpg)
...
![](https://article-1304941664.cos.ap-guangzhou.myqcloud.com/advertisement/tencent_ad_ad_level.png)
